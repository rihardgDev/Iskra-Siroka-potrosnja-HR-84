...
Far left card is a ram card containing 4116 DRAM chips, the middle one must be a I/O board with ROMs and processors and the right one must contain video generating circutry.
